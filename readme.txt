...
Yes, using custom CSS and the selector '#progressBar' you can style the progress bar to your wildest dreams.
...
= 1.1.0 =
* Add jQuery as dependency for the booking progress bar JavaScript
* Bug fix with adding menu to the admin menu causing PHP warning
* Tested with WordPress v6.4 and MotoPress v4.8
